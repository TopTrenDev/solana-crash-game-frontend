...
export default function UserInfoModal() {
  ...
  const { isUser, userId } = useAppSelector((state: any) => state.tempuser);
            ...
            <div className='flex w-full flex-col gap-4 px-[40px]'>
              <div className='flex flex-col gap-2'>
                <div className="flex w-full flex-col justify-between lg:flex-row">
                  ...
                  <h3 className="text-[16px] font-semibold">81111</h3>
                </div>
                <div className="flex w-full flex-col justify-between lg:flex-row">
                  <h3 className="w-full text-[16px] font-normal text-gray-500 lg:w-1/3">
                    Total Wagered:
                  </h3>
                  <h3 className="text-[16px] font-semibold">$7,207.444</h3>
                </div>
              </div>
              <div className='flex flex-col gap-2'>
                <div className="flex w-full flex-col justify-between lg:flex-row">
