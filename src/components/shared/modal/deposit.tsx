        ...
        <div className="flex w-full flex-col items-center gap-10 rounded-b-[8px] bg-[#2C2852] px-[30px] py-[36px]">
          <div className="flex w-full flex-col gap-6">
            <div className="flex w-full flex-col items-center justify-between gap-3">
              <span>
                Send any amount of solana to this address to fund your account:
              </span>
            </div>
            <div className="flex flex-col gap-2">
              ...
              <div className="relative">
                ...
                <CopyToClipboard
                  ...
                  onCopy={onCopyText}
                  className="absolute right-0 top-0 flex h-full items-center justify-center rounded-r-lg bg-[#463E7A] px-4 text-gray500"
                >
                  <button>Copy</button>
                </CopyToClipboard>
              </div>
